#!/usr/bin/env python3
"""Select Cycle22's first label-blind mirror seed with team-2 lead Terapagos."""
...
def main() -> None:
    ...
    for offset in range(MAX_CANDIDATES):
        ...
        if (fields[1] or fields[0]) != "Terapagos":
            continue
        payload = {
            "schema": "metagross-cycle22-form-smoke-selection/v1",
            ...
            "tested_seed_count": offset + 1, "format": "gen9randombattle", "pair_index": 1,
            "team_1_seed": first, "team_2_seed": second,
            "team_1_sha256": generated["team_1_sha256"], "team_2_sha256": generated["team_2_sha256"],
        ...
        return
    raise RuntimeError("no Terapagos lead found in frozen Cycle22 scan range")

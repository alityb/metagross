#!/usr/bin/env python3
"""Select Cycle25's first label-blind fresh team-2 Terapagos lead."""
...
def main() -> None:
    ...
    for offset in range(MAX_CANDIDATES):
        ...
        if (fields[1] or fields[0]) != "Terapagos":
            continue
        payload = {
            "schema": "metagross-cycle25-form-smoke-selection/v1",
        ...
        return
    raise RuntimeError("no Terapagos lead found in frozen Cycle25 scan range")

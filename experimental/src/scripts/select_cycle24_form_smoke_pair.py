#!/usr/bin/env python3
"""Select Cycle24's first label-blind fresh team-2 Terapagos lead."""
...
def main() -> None:
    ...
    for offset in range(MAX_CANDIDATES):
        ...
        if (fields[1] or fields[0]) != "Terapagos":
            continue
        payload = {
            "schema": "metagross-cycle24-form-smoke-selection/v1",
            ...
            "team_2_sha256": generated["team_2_sha256"], "team_2_lead": "Terapagos",
        }
        args.output.parent.mkdir(parents=True, exist_ok=True)
        args.output.write_text(json.dumps(payload, indent=2, sort_keys=True) + "\n")
        print(json.dumps(payload, sort_keys=True))
        return
    raise RuntimeError("no Terapagos lead found in frozen Cycle24 scan range")

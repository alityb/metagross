...
| 3 | Completed-Q harmful under determinization | 10-40 (p = 1.2e-5 one-sided), 37% flips | Exact p computed; mechanism (strategy fusion) argued from telemetry | REPLICATED at power (2026-09-04): 69-131 (34.5%, CI [28.3,41.3]), mirrored, activation-verified — harmful CONFIRMED |
